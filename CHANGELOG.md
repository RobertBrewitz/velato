...
- Respect trim-path mode for independent and sequential trimming, preserving disconnected contours and accounting for nested shape transforms. Trim-path behavior follows the [Lottie specification](https://lottie.github.io/lottie-spec/latest/specs/shapes/#trim-path), intentionally preferring it over ThorVG behavior where they differ.
