...
//! Trim-path semantics follow the Lottie specification, not ThorVG compatibility.
//! Where ThorVG differs, preserve the specified path order and parallel/sequential
//! mode behavior rather than reproducing its output.
//! See <https://lottie.github.io/lottie-spec/latest/specs/shapes/#trim-path>.
...
fn trim_contour(
    ...
    for &(start, end) in intervals {
        // Wrapped ranges on a closed contour meet at its authored start point.
